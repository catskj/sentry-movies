 ...
 #   if user_id in ADMINS: return
    ...
    if await db.get_pm_search_status(bot_id):
        ...
        await message.reply_text("<b><i>ɪ ᴀᴍ ɴᴏᴛ ᴡᴏʀᴋɪɴɢ ʜᴇʀᴇ. ꜱᴇᴀʀᴄʜ ᴍᴏᴠɪᴇꜱ ɪɴ ᴏᴜʀ ᴍᴏᴠɪᴇ ꜱᴇᴀʀᴄʜ ɢʀᴏᴜᴘ.</i></b>",
                                 reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("📝 ᴍᴏᴠɪᴇ ꜱᴇᴀʀᴄʜ ɢʀᴏᴜᴘ ", url=f'https://t.me/NeverStopI')]]))
...
async def cb_handler(client: Client, query: CallbackQuery):
    if query.data == "close_data":
        ...
        reply_markup = InlineKeyboardMarkup(btn)
        m=await query.message.reply_sticker("CAACAgUAAxkBAAEBJCNnznGQmb6WXWhsoAABb6zx4VII_c0AAggOAAJLcjBVGsdsUTPkf3U2BA") 
        await m.delete()
        ...
        buttons = [[
            InlineKeyboardButton('☆ 𝙎𝙚𝙣𝙙 𝗥𝗲𝗱𝗲𝗲𝗺 ☆', url=f'https://t.me/NeverStopI')
        ],[
    ...
    # If the user isn't an admin, return
      ...
      await client.edit_message_media(
          ...
          media=InputMediaAnimation(
            media="https://imgur.com/a/dxmXHhP",
       ...
       await client.edit_message_media(
          ...
          message_id=query.message.id,
          media=InputMediaAnimation(
            media="https://imgur.com/a/8GAHKCs",
       ...
       buttons = [[
	      InlineKeyboardButton('⇆ ᴀᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘs ⇆', url=f'http://t.me/{temp.U_NAME}?startgroup=start')
              ...
              InlineKeyboardButton('sᴜᴘᴘᴏʀᴛ', url=f'https://t.me/NeverStopI'),
       ]]
       reply_markup = InlineKeyboardMarkup(buttons)
       await client.edit_message_media(
          chat_id=query.message.chat.id,
          message_id=query.message.id,
          media=InputMediaAnimation(
            media="https://tinyurl.com/2bv8gk6x",
